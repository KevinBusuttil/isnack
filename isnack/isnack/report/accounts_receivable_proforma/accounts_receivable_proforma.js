...
frappe.query_reports["Accounts Receivable Proforma"] = {
	filters: [
		{
			fieldname: "company",
			label: __("Company"),
	...
	onload: function (report) {
		report.page.add_inner_button(__("Accounts Receivable Proforma Summary"), function () {
			var filters = report.get_values();
			frappe.set_route("query-report", "Accounts Receivable Proforma Summary", { company: filters.company });
		});
	},
};

erpnext.utils.add_dimensions("Accounts Receivable Proforma", 9);
